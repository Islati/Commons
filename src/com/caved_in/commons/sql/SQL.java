...
public class SQL {
	 ...
	 *
	 * @param TableName Name of Table to create within the database
	 * @param Values    Value to put in said Table if created
	 ...
	 *
	 * @param Table Table to get the row-count of
