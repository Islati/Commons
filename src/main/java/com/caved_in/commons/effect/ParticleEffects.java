...
public enum ParticleEffects {
	 ...
	 * 1.8 only!
	 */
	ITEM_CRACK("iconcrack", 54),
	/**
	 * 1.8 only!
	 */
	BLOCK_CRACK("blockcrack", 55),
	/**
	 * 1.8 only!
	 */
	BLOCK_DUST("blockdust", 56),
	/**
	 * 1.8 only!
	 */
	WATER_DROP("droplet", 57),
	/**
	 * 1.8 only!
	 */
	ITEM_TAKE("take", 58),
	 ...
	 * 1.8 only!
	 */
	MOB_APPEARANCE("mobapearance", 59),
	 ...
	 * 1.9 Additions!
	 */
	DRAGON_BREATH("dragonbreath", 63),

	END_ROD("endRod", 64),

	DAMAGE_INDICATOR("damageIndicator", 65),

	SWEEP_ATTACK("sweepAttack", 66),
