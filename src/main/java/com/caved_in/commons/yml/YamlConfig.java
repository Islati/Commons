        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            try {
                ...
                if (!skipFailedObjects) {
                    throw new InvalidConfigurationException(String.format("Could not save the Field '%s'", field.getName()), e);
                }
            }
        }
    }
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (root.has(path)) {
                ...
                try {
                    ...
                    if (!skipFailedObjects) {
                        throw new InvalidConfigurationException(String.format("Could not get field %s", field.getName()), e);
                    }
                }
            }
        }
