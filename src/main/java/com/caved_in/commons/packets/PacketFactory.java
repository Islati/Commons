package com.caved_in.commons.packets;
...
import com.caved_in.commons.packets.protocol.Protocol;
import com.caved_in.commons.packets.protocol.Sender;
	...
	public static List<Object> craftEquipmentPacket(NPC npc) {
		...
		for (SlotType type : SlotType.values()) {
			if (npc.getInventory(type) != null) {
				...
				packet.write("c", ItemHandler.toNMS(npc.getInventory(type)));
