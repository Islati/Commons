...
public class Items {
    ...
    public static boolean isPlayerSkull(ItemStack item) {
        ...
        try {
            ...
            Onyx.getInstance().getLogger().log(Level.SEVERE, "Metadata cast exception", e);
        }
     ...
     * @throws InvalidMaterialNameException if no material has a name or alias matching the search
     */
