...
import com.devsteady.onyx.game.event.UserJoinEvent;
...
public class UserManager<T extends User> implements IUserManager<T> {
    ...
    /**
     * Initialize a new user manager and set the derived class of {@link User} which the manager handles.
     *
     * @param userClass the derived class of {@link User} which the manager handles
     */
     ...
     *
     * @param userClass the class deriving from {@link User}, which the usermanager will handle.
     */
