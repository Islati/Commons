...
import com.devsteady.onyx.threading.tasks.NameFetcherCallable;
import com.devsteady.onyx.threading.tasks.UuidFetcherCallable;
...
import com.devsteady.onyx.world.WorldHeight;
...
public class Players {
    ...
    public static void kick(Player player, String reason, boolean thread) {
        ...
        Onyx.getInstance().getThreadManager().runTaskOneTickLater(new KickPlayerThread(player.getUniqueId(), reason));
    }
     ...
     *
     * @param player the player to get the {@link com.devsteady.onyx.world.WorldHeight} of
     * @return {@link com.devsteady.onyx.world.WorldHeight} based on the players y-axis position
     * @see com.devsteady.onyx.world.WorldHeight
     * @since 1.0
     */
    ...
    public static boolean hasItemInHand(Player player) {
        ...
        ItemStack mainHand = playerInv.getItemInHand();
    ...
    public static boolean hasItemInHand(Player player, ItemStack compare) {
        ...
        return mainHand.isSimilar(compare);
    }
    ...
    public static void removeFromHand(Player player, int amount) {
        ...
        ItemStack handItem = Items.removeFromStack(player.getItemInHand(), amount);
     ...
     * @see Inventories#contains(org.bukkit.inventory.Inventory, org.bukkit.Material, String)
     */
    ...
    /**
     * Force a player to respawn, skipping the respawn screen.
     * Relies on NMS and reflection to provide implementation per Bukkit version.
     *
     * @param p player to respawn.
     */
    public static void forceRespawn(Player p) {
        ...
        Plugins.getLoggedScheduler().scheduleSyncRepeatingTask(Onyx.getInstance(), new BukkitRunnable() {
            @Override
            public void run() {
                try {
