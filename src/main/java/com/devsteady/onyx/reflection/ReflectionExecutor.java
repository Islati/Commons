...
public class ReflectionExecutor {
    ...
    static class ReflectionObject {
         ...
         * For example: get("operators", ReflectionObject.class); will get the operators object. As the operators object is not a instance of
         * ReflectionObject, it tries to invoke <i>new ReflectionObject(operators);</i>
         *
        ...
        private <T> T castOrCreate(Object obj, Class<T> as) {
            try {
