                ...
                for (String include : verifyArgs) {
                    try {
                        if (transform(sender, argument, include) != value) {
                            throw new java.lang.VerifyError(argument.getMessage("include_error", valueRaw));
                        }
                    } catch (TransformError e) {
                        throw (IllegalArgumentException) new IllegalArgumentException("Could not transform the verify argument " + include, e);
                    }
                }
            }
        });
            ...
            public void verify(CommandSender sender, CommandArgument argument, String verifyName, String[] verifyArgs, T value, String valueRaw) throws java.lang.VerifyError {
                for (String exclude : verifyArgs) {
                    try {
                        ...
                        throw (IllegalArgumentException) new IllegalArgumentException("Could not transform the verify argument " + exclude, e);
                    }
                }
            }
        });
